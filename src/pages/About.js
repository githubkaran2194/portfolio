                  ...
                  <Grid container spacing={1} sx={{ m: "10px 0" }}>
                    {[1, 2, 3, 4, 5, 6].map((item) => (
                      <Grid item md={3} sm={6} xs={6} key={item.id}>
                        <Card sx={skillCard}>
                          <CardMedia src="https://satyam-pund.netlify.app/static/media/html.6e930594286d8afe4c79.png" component={'img'} width={"90%"} height={50} sx={{ objectFit: "contain" }} />
                          <CardContent>
                            <Typography sx={{ letterSpacing: "1px", fontWeight: "500" }} textAlign={'center'}>HTML</Typography>
                          </CardContent>
                        </Card>
                      </Grid>
                    ))}
